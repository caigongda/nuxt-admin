	...
	export default{
		...
		async asyncData ({ params }) {
			let [res1, res2, res3] = await Promise.all([
		      axios.post('/api/index.php/Number/banner'),
		      axios.post('/api/index.php/Number/numberkind'),
		      axios.post('/api/index.php/Number/getUrl')
		    ]);
		    return {
		    	indexImg: res1.data,
		        hotnumber: res2.data.hotnumber,
		        newnumber: res2.data.newnumber,
		        furls: res3.data,
		    }
		    return axios.post('/api/index.php/Number/banner')
		    .then((res) => {
		      return { indexImg: res.data }
		    })
		},
		created(){
			//this.getBanner();
